# -*- coding: utf-8 -*-
"""
ATTENTION: Ce script génère des DONNÉES FICTIVES pour tests et démonstration
========================================================================
...
Données générées:
- 2000 propriétés fictives (prix réalistes par ville)
- 20 villes françaises >10000 habitants (RGPD compliant)
- Données démographiques cohérentes

Pour utiliser de VRAIES données scrapées, utilisez les scrapers dans src/scrapers/
"""
